...
<div class="full_code">
    ...
    <script>
        ...
        $("#section-title-slider-text").text("Страница не найдена")
                                    ...
                                    <div class="blog_item_img">
                                        <div style="width: 300px; height: 300px; margin-right: auto; margin-left: auto">
                                            <img class="card-img rounded-0"
                                                 src="${pageContext.request.contextPath}/vectors/404-error.svg"
                                                 width="300" height="300" alt="404"></div>
                                    </div>

                                    <div class="blog_details blog_details_error news">
                                        <div class="blog_item_img">
                                            <a onclick="" class="blog_item_date" id="blog_item_date_error">
                                                <h3>404 Страница не найдена <i class="fa fa-exclamation-triangle"></i>
                                                </h3>
                                                <p>Скорее всего, вы перешли по "битой" ссылке либо допустили ошибку в
                                                    адресе страницы</p>
                                            </a>
