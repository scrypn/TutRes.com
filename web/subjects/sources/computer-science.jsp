<script>
    ...
    $("#section-title-slider-text").text("Информатика")
            ...
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="blog_left_sidebar">
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".15s">
                        <div class="blog_item_img"
                            ...
                            <img class="card-img rounded-0"
                                 src="${pageContext.request.contextPath}/vectors/comp-science.svg" id="maths_pic_1"
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block">
                                <h2>Приветствуем вас в разделе "Информатика"!</h2>
                            </a>
                            <p>Приветствуем вас в разделе "Информатика". Здесь вы можете найти репетитора и подать
                    ...
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s"
                             id="instruction_cs_student" style="display: none">
                        <div class="blog_details">
                            <a class="d-inline-block">
                    ...
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s"
                             id="instruction_cs_tutor" style="display: none">
                        <div class="blog_details">
                            <a class="d-inline-block">
                                ...
                                <div class="recent_joblist_wrap">
                                    <div class="recent_joblist white-bg ">
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <h4 id="title-student-tutor-cs">Загрузка...</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="job_lists m-0">
                                    <div class="row" id="tutor-cs-container">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    getSepSubData("#title-student-tutor-cs", "#tutor-cs-container", main_site_path + "vectors/group.svg", "Информатика", 12);
    var user = getCookie("user");
    if (user === undefined || user.split('/')[3] === "Ученик") document.getElementById("instruction_cs_student").style.display = "block";
    else document.getElementById("instruction_cs_tutor").style.display = "block";
