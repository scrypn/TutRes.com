<script>
    ...
    $("#section-title-slider-text").text("Физика")
                ...
                <div class="blog_left_sidebar">
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".15s">
                        <div class="blog_item_img"
                            ...
                            <img class="card-img rounded-0" src="${pageContext.request.contextPath}/vectors/physics.svg"
                                 id="phys_pic_1" width="300" height="300" alt="PHYS.TutRes.com">
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block">
                                <h2>Приветствуем вас в разделе "Физика"!</h2>
                            </a>
                            <p>Приветствуем вас в разделе "Физика". Здесь вы можете найти репетитора и подать запрос на
                                его добавление по данному предмету, если вы - ученик, и просматривать, принимать и
                                отклонять запросы на добавление репетитора
                    ...
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s"
                             id="instruction_phys_student" style="display: none">
                        <div class="blog_details">
                            <a class="d-inline-block">
                    ...
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s"
                             id="instruction_phys_tutor" style="display: none">
                        <div class="blog_details">
                            <a class="d-inline-block">
                                ...
                                <div class="recent_joblist_wrap">
                                    <div class="recent_joblist white-bg ">
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <h4 id="title-student-tutor-phys">Загрузка...</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="job_lists m-0">
                                    <div class="row" id="tutor-phys-container">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    getSepSubData("#title-student-tutor-phys", "#tutor-phys-container", main_site_path + "vectors/group.svg", "Физика", 12);
    var user = getCookie("user");
    if (user === undefined || user.split('/')[3] === "Ученик") document.getElementById("instruction_phys_student").style.display = "block";
    else document.getElementById("instruction_phys_tutor").style.display = "block";
    $("#feedback_phys_block").on('click', function () {
        toFeedBackPage();
    });
</script>

<!-- <div id="tutor_maths_1" class="general_info maths_blocks left_maths_blocks" style="display: inline-block"><h2><font size="5" face="Times New Roman">
<center>1. Скрипниченко Николай</center></font></h2> <h3><font size="4" face="Times New Roman">
<center><br>Личные данные</center></font></h3> <h4 style="text-align: left"><font size="3" face="Times New Roman">
<br>преподаватель математики и информатики TUTOREA.RU, java разработчик<br>опыт преподавания: 1 год<br>Возраст: 15 лет<br>сферы деятельности: подготовка к
контрольным и итоговым работам по данным предметам 5-9 класса, подготовка к ОГЭ на 25+ баллов, обучение java программированию,
созданию web, desktop и мобильных приложений на java для начинающих<br>требуемый оклад: 350 руб/занятие по школьной программе, 400 руб/занятие - с углублением в предмет</font></h4></div>-->
