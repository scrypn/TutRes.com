<script>
    ...
    $("#section-title-slider-text").text("Все предметы")
                ...
                <div class="blog_left_sidebar">
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".15s">
                        <div class="blog_item_img"
                            ...
                            <img class="card-img rounded-0" src="${pageContext.request.contextPath}/vectors/books.svg"
                                 id="books_pic_1" width="300" height="300" alt="all.subs.TutRes.com">
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block">
                                <h2>Приветствуем вас в разделе "Все предметы TutRes.com"!</h2>
                            </a>
                            <p>Приветствуем вас в разделе "Все предметы TutRes.com". Здесь вы можете найти репетитора и
                                подать запрос на его добавление по всем предметам кроме тех, разделы которых
                                представлены отдельно (на данный момент - Математика и Физика), если вы - ученик, и
                                просматривать, принимать и отклонять запросы от учеников
                                ...
                                <div class="recent_joblist_wrap">
                                    <div class="recent_joblist white-bg ">
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <h4 id="title-student-tutor-all-subs">Загрузка...</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="job_lists m-0">
                                    <div class="row" id="tutor-all-subs-container">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    AllSubjectsButton("#title-student-tutor-all-subs", "#tutor-all-subs-container", main_site_path + "vectors/group.svg", 12);
