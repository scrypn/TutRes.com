<script>
    ...
    $("#section-title-slider-text").text("Программирование")
            ...
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="blog_left_sidebar">
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".15s">
                        <div class="blog_item_img"
                            ...
                            <img class="card-img rounded-0"
                                 src="${pageContext.request.contextPath}/vectors/programming.svg" id="maths_pic_1"
                                 width="300" height="300" alt="maths.TutRes.com">
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block">
                                <h2>Приветствуем вас в разделе "Программирование"!</h2>
                            </a>
                            <p>Приветствуем вас в разделе "Программирование". Здесь вы можете найти репетитора и подать
                                запрос на его добавление по данному предмету, если вы - ученик, и просматривать,
                                принимать и отклонять запросы от учеников
                    ...
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s"
                             id="instruction_programming_student" style="display: none">
                        <div class="blog_details">
                            <a class="d-inline-block">
                    ...
                    <article class="blog_item wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".25s"
                             id="instruction_programming_tutor" style="display: none">
                        <div class="blog_details">
                            <a class="d-inline-block">
                                ...
                                <div class="recent_joblist_wrap">
                                    <div class="recent_joblist white-bg ">
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <h4 id="title-student-tutor-programming">Загрузка...</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="job_lists m-0">
                                    <div class="row" id="tutor-programming-container">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    getSepSubData("#title-student-tutor-programming", "#tutor-programming-container", main_site_path + "vectors/group.svg", "Программирование", 12);
    var user = getCookie("user");
    if (user === undefined || user.split('/')[3] === "Ученик") document.getElementById("instruction_programming_student").style.display = "block";
    else document.getElementById("instruction_programming_tutor").style.display = "block";
